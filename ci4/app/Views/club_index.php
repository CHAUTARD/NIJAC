...
const LS_ORDRE    = 'nijac_en27_colonnes_ordre';
// Ordre naturel du thead = source de vérité des champs existants.
const CHAMPS_NATURELS = [...document.querySelectorAll('#tbl-clubs thead th[data-field]')]
...
// selon ordreColonnes. Les cellules sans data-field (colonne actions) restent en fin.
function appliquerOrdreColonnes() {
    document.querySelectorAll('#tbl-clubs tr').forEach(tr => {
        const parCle = {}, reste = [];
