...
<head>
    ...
    <title>NIJAC – Disponibilités JA v2 (EN24)</title>
...
<div id="page-header">
    ...
    <h1>Disponibilités JA v2 <small class="opacity-75" style="font-size:.75rem;">(EN24)</small></h1>
...
const BASE = '<?= site_url('disponibilite-ja-v2') ?>';
